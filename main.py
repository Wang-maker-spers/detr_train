...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='dataset/',type=str)
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')

    parser.add_argument('--output_dir', default='',help='path where to save, empty for no saving')  # default='out',
...
def main(args):
    ...
    # print(dataset_train.coco.anns) 字典 ,只有标注，没有图片  ，  目标  修改此处标注  anns
    ...
    for epoch in range(args.start_epoch, args.epochs): 
        ...
        # print(dict_o)  其实不用在此处修改 json ,可以放在 engine.py文件中，训练epoch之后。
...
"""
python main.py --batch_size 2 --no_aux_loss --eval --resume https://dl.fbaipublicfiles.com/detr/detr-r50-e632da11.pth
